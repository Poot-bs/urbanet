    ...
    <div style={{ fontFamily: "'DM Sans', 'Segoe UI', sans-serif", color: "#111", background: "#fff", minHeight: "100vh" }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .social-icon-btn:hover { background: transparent; border-color: rgba(255,255,255,0.5); color: #fff; }
      ...
      <section style={{
        ...
        <img
          ...
          style={{
            ...
            width: "68%", height: "100%", objectFit: "cover",
        ...
        <div style={{
          ...
          background: "linear-gradient(90deg, rgba(26,32,44,0.95) 0%, rgba(26,32,44,0.7) 45%, rgba(26,32,44,0.1) 75%, transparent 100%)",
        }} />
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 580 }}>
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.75)", lineHeight: 1.65, marginBottom: 32, maxWidth: 480 }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 13, color: "#888", marginBottom: 14, paddingLeft: 28 }}>1234 Maple Avenue, Greenfield, TX</p>
          <button style={{
            width: "100%",
            background: "#111",
            color: "#fff",
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 15, color: "#fff" }}>50K+</div>
            <div style={{ fontSize: 12.5, color: "rgba(255,255,255,0.75)" }}>Happy Clients</div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "72px 48px 0" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 52, maxWidth: 1200, margin: "0 auto 52px auto" }}>
          <h2 style={{
            ...
            Connecting People With<br />Perfect Properties
          </h2>
          <p style={{ fontSize: 15, color: "#666", lineHeight: 1.65, maxWidth: 360, paddingTop: 6 }}>
      ...
      <section style={{ padding: "80px 48px 80px" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 48, maxWidth: 1200, margin: "0 auto 48px auto" }}>
          <h2 style={{
          ...
          <p style={{ fontSize: 15, color: "#888", lineHeight: 1.6, maxWidth: 320, paddingTop: 10 }}>
            We are redefining real estate with innovation and excellence.
          </p>
        </div>

        {/* Cards grid */}
        <div style={{ display: "flex", gap: 18, maxWidth: 1200, flexWrap: "wrap", margin: "0 auto" }}>
          {services.map((s, i) => (
      ...
      {/* ── FOOTER  */}
      <footer style={{ background: "#1a1a1a", padding: "60px 48px 0" }}>
        <div style={{
          display: "flex",
          gap: 48,
          flexWrap: "wrap",
        ...
        {/* Divider */}
        <div style={{ height: 1, background: "rgba(255,255,255,0.12)", maxWidth: 1800}} />
